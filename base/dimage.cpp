...
DImage::DImage(const QString &fileName)
: m_fileName(fileName)
{
...
filetype DImage::getFileType(CBMFile::Type t)
{
  filetype ft;
  switch(t) {
    case CBMFile::DEL: ft=T_DEL; break;
    case CBMFile::SEQ: ft=T_SEQ; break;
    default:
    case CBMFile::PRG: ft=T_PRG; break;
    case CBMFile::USR: ft=T_USR; break;
    case CBMFile::REL: ft=T_REL; break;
    case CBMFile::CBM: ft=T_CBM; break;
    case CBMFile::DIR: ft=T_DIR; break;
  }
  return ft;
}
...
int DImage::numTracks() const
{
  return di_tracks(m_diskImage->type);
}
